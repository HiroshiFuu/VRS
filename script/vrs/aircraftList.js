var VRS;
(function (VRS) {
    console.log("replaced aircraftList");
    // var RR_Icao;
    // $.getJSON("./RR_Icao.json", function(json) {
    //     RR_Icao = json;
    //     console.log("loaded RR_Icao");
    // });
            ...
            if (aircraftListJson) {
                ...
                for (var i = 0; i < length; ++i) {
                    ...
                    if (isNaN(aircraftJson.Id))
                        continue;
                    if (aircraftJson.Icao !== undefined) {
                        // console.log(aircraftJson);
                        // console.log(RR_Icao[aircraftJson.Icao.toLowerCase()]);
                        // if (RR_Icao[aircraftJson.Icao] === undefined)
                        //     continue;
                        // else {
                        //     aircraftJson.Engine = RR_Icao[aircraftJson.Icao];
                        //     // console.log(aircraftJson);
                        // }
                    }
                    else {
